...
import { MessageSquare, Phone, CheckCircle, DollarSign, Users, Star, TrendingUp } from "lucide-react"
          ...
          <div className="flex-1 overflow-auto py-2">
            <nav className="grid items-start px-4 text-sm font-medium">
              <button
                ...
                className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-colors ${activeTab === "overview"
              ...
              <button
                ...
                className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-colors ${activeTab === "my-issues"
                  ? "bg-blue-50 text-blue-600"
                  : "text-gray-600 hover:text-blue-600 hover:bg-blue-50"
                  }`}
              >
              ...
              <button
                ...
                className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-colors ${activeTab === "social-media"
                  ? "bg-blue-50 text-blue-600"
                  : "text-gray-600 hover:text-blue-600 hover:bg-blue-50"
                  }`}
              >
